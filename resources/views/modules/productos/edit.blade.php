   ...
   <form action="{{ route('producto-update', $items->id) }}" method="post">
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" name="codigo_producto" id="codigo_producto" class="form-control" value="{{ $items->codigo_producto }}">
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <input type="text" name="color" id="color" class="form-control" value="{{ $items->color }}">
            </div>
        </div>
        <div class="row">
            <div class="col">
                <label for="precio">Precio</label>
                <input type="text" name="precio" id="precio" class="form-control" value="{{ $items->precio }}">
            </div>
            <div class="col">
